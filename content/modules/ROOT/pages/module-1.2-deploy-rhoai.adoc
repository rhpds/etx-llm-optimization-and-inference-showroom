...
First, we'll clone the ETX vLLM optimization repo.
...
Let's take a look at our provided custom values file (etx-llm-optimization-and-inference-leveraging-showroom/workshop_code/deploy_vllm/vllm_rhoai_custom_1/values.yaml):
