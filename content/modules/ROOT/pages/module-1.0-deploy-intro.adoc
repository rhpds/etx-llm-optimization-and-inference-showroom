...
**RHEL (1.1)**: Bare metal and edge deployments requiring direct hardware control and minimal overhead. Ideal for single-node inference, air-gapped environments, or maximum performance scenarios. Notes that we are not covering this deployment method in this lab.
