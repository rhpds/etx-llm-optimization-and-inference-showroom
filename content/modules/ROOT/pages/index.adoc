...
Before diving into the modules, review the xref:introduction.adoc#introduction[Workshop Introduction] to understand the business context, challenges, and value of LLM optimization.
...
**Deploy RH Inference Server**

* **1.1 OpenShift AI Deployment**: Leverage Red Hat OpenShift AI platform for managed LLM serving with enterprise features

**Key Skills**: Cloud-native deployment
...
* Deploy production-ready LLM inference server
...
After completing all modules, visit the xref:conclusion.adoc#conclusion[Workshop Conclusion] for key takeaways, next steps, and additional resources to continue your LLM optimization journey.
